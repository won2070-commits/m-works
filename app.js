...
const APP_VERSION = 'v90 · 2026-07-24';
...
function renderMaterials(m) {
  m.innerHTML = `
    ...
    <div class="card" style="margin-top:22px">
      <h3>🏛 예화 창고 <span class="badge" style="background:var(--lilac);font-weight:700">${DB.illustLib.length}편</span> <span class="badge" style="background:var(--mint)">자동 사용</span></h3>
      <p class="ai-note" style="margin-top:6px">여기 담긴 예화는 <b>위 자료 개수에 잡히지 않고, 작성 전 확인창에도 나오지 않습니다.</b> 설교문을 쓸 때마다 앱이 설교 주제를 읽고 창고에서 가장 어울리는 예화 <b>한 편</b>을 스스로 골라 알맞은 자리에 넣습니다. 에버노트 내보내기(.enex) 파일을 아래 자료 담기 칸에 끌어다 놓으면 이 창고로 들어옵니다.</p>
      ${DB.illustLib.length ? `
      <details style="margin-top:10px"><summary style="cursor:pointer;font-weight:600">창고 열어 보기</summary>
